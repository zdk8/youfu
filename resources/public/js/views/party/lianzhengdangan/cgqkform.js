define(function () {
    return {
        render: function (local,option) {
            ...
            var field2 = ['gx_relationship','gx_name','gx_businessscope','gx_registercapital','gx_address','gx_legalperson','gx_contact'];//主要社会关系经商办企业情况
            ...
            local.find('[name=yl_id]').val(datas[0].yl_id);
            if(datas != "false"){
                var data = datas[0];
