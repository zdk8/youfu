...
define(function(){
    ...
    /*新增数据时进入*/
    var removeFunc = function(local,option){
        ...
        var btns = '<div id="ft_ssry1" style="padding:5px;" align="center">' +
            '<input type="button" value="转移" class="btns" opt="agree">&nbsp;' +
            '<input type="button" value="取消" class="btns" opt="notagree">&nbsp;' +
            '</div>';
