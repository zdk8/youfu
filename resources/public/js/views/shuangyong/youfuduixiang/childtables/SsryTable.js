define(function(){
    var arr_combobox = ['sex','nation','marriage','hktype','eachtype','deadrelation','awardlevel',
    ...
    var saveFunc = function(local,option){
        ...
        cj.reportFunc(local,option,districtid,'212','');
    }
    ...
    var updateFunc = function (local,option) {
        ...
        cj.reportFunc(local,option,districtid,'212',record.sc_id);
    }
