$.extend({
    webox:function(option){
        ...
        $(document).ready(function(e){
            ...
            $('#'+option['locked']+' .span').bind('click',function(e){
                closePop();
            });
            $('.webox').bind('close',closePop);
            $('.webox').keydown(function (e) {
                if (e.which === 27) { closePop();}
            });
