...
Two middleware functions are provided by default in the `newpension.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `newpension.handler` namespace to manage the enabled middleware.
