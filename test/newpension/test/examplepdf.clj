...
(pdf
 ...
 [:paragraph
    {:style :bold :size 10 :ttf-name "C:\\Windows\\Fonts\\STFANGSO.TTF"
     }
...
纵死侠骨香，不惭世上英。 谁能书阁下，白首太玄经⑾"]
 ...
 [:paragraph
  {:style :bold :size 10 :family :halvetica :color [0 255 221] :ttf-name "C:\\Windows\\Fonts\\STFANGSO.TTF"
   }
